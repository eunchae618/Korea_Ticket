...
export const patchRegister4 = async (password, newPassword) => {
  try {
    const response = await axiosInstance.patch("/auth/register4", {
      password,
      newPassword,
    });
    return response.data;
...
export const patchChangePassword = async (password, newPassword) => {
  try {
